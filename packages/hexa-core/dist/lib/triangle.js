import { BASE_TRIANGLE_HEIGHT, BASE_TRIANGLE_WIDTH, } from "../constants";
...
export class Triangle {
    ...
    wildAnimationMask;
    pos;
    constructor(board, x, y, colour, powerup, twoxImage, bombImage, wildImage) {
        this.board = board;
    ...
    getMappedCorners() {
        ...
        return {
            point: new Vector2D(mappedX, this.flipped()
                ? mappedY + BASE_TRIANGLE_HEIGHT / 2
                : mappedY - BASE_TRIANGLE_HEIGHT / 2),
            left: new Vector2D(mappedX - BASE_TRIANGLE_WIDTH / 2, this.flipped()
                ? mappedY - BASE_TRIANGLE_HEIGHT / 2
                : mappedY + BASE_TRIANGLE_HEIGHT / 2),
            right: new Vector2D(mappedX + BASE_TRIANGLE_WIDTH / 2, this.flipped()
                ? mappedY - BASE_TRIANGLE_HEIGHT / 2
                : mappedY + BASE_TRIANGLE_HEIGHT / 2),
        };
    }
